...
const SuperAdminTenantsPage = lazy(() => import('./pages/SuperAdmin/Tenants'));
const SuperAdminUsersPage = lazy(() => import('./pages/SuperAdmin/Users'));
  ...
  return (
    <>
      ...
      <Suspense fallback={<LoadingScreen />}>
        ...
        />
        <Route
          path={ROUTES.SUPERADMIN_TENANTS}
          element={
            <SuperAdminRoute>
